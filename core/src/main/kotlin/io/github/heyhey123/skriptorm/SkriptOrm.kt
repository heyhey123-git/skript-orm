package io.github.heyhey123.skriptorm
...
class SkriptOrm : JavaPlugin() {
    companion object {

        /**
         * The oldest Skript this plugin can run on.
         *
         * Every element in [io.github.heyhey123.skriptorm.skript] is registered through the addon
        ...
        lateinit var instance: SkriptOrm
            private set
    ...
    private fun skriptIsSupported(): Boolean {
        ...
        logger.severe(
            "skript-orm requires Skript $MINIMUM_SKRIPT_VERSION or newer, but this server runs " +
                "Skript $running. Disabling skript-orm: upgrade Skript and restart the server."
        )
        return false
    }
