...
internal object LogoPrinter {
    ...
    private val wordmark: List<String> = """
        ...
        __  ___/__  /___________(_)_________  /__  __ \_____________ ___
        _____ \__  //_/_  ___/_  /___  __ \  __/  / / /_  ___/_  __ `__ \
        ____/ /_  ,<  _  /   _  / __  /_/ / /_ / /_/ /_  /   _  / / / / /
        /____/ /_/|_| /_/    /_/  _  .___/\__/ \____/ /_/    /_/ /_/ /_/
                                  /_/
    ...
    fun print(version: String) {
        ...
        send(listOf(Span(margin + "skript-orm ", GRAY)) + gradientSpans(version))
        send(listOf(Span(border, DARK_GRAY)))
    }

    /** Prints the line a server sees when the plugin is disabled. */
    fun printFarewell(version: String) {
        send(listOf(Span("skript-orm $version ", GRAY), Span("disabled.", DARK_GRAY)))
    }
    ...
    private fun send(spans: List<Span>) {
        SkriptOrm.instance.logger.info(ansi(spans))
    }
