...
open class JdbcQueries(
    ...
    override fun insertIfAbsent(values: Map<String, Any?>) = JdbcInsertIfAbsent(values, dataSource)
    override fun update(values: Map<String, Any?>, limit: Int?, where: WhereClause?) =
        JdbcUpdate(values, limit, where, dataSource)
    override fun updateById(id: Any, values: Map<String, Any?>) = JdbcUpdateById(id, values, dataSource)
    override fun upsertById(id: Any, values: Map<String, Any?>) = JdbcUpsertById(id, values, dataSource)
    override fun delete(limit: Int?, where: WhereClause?) = JdbcDelete(limit, where, dataSource)
